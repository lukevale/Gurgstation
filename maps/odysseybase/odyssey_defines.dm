...
/datum/map/odysseybase
	...
	zlevel_datum_type = /datum/map_z_level/odysseybase
	...
	station_name  = "OPI Project Odyssey"
	station_short = "The Odyssey"
	facility_type = "base"
...
//							NETWORK_HALLS
	...
	default_skybox = /datum/skybox_settings/odysseybase
...
/datum/map/groundbase/perform_map_generation()	//Z_LEVEL_GB_BOTTOM,Z_LEVEL_GB_MIDDLE,Z_LEVEL_GB_TOP
	...
	return 1
*/
/datum/skybox_settings/odysseybase
	icon_state = "space5"
	use_stars = FALSE
...
*/
/obj/effect/overmap/visitable/sector/athena
	name = "Athena"
	desc = "A small, volcanically active moon."
	scanner_desc = @{"[i]Registration[/i]: OPI Project Odyssey
[i]Class[/i]: Installation
[i]Transponder[/i]: Transmitting (CIV), Odysseus IFF
[b]Notice[/b]: Odysseus Base, authorized personnel only"}
	known = TRUE
	in_space = TRUE
...
/datum/map_z_level/odysseybase/level_zero
	z = Z_LEVEL_ODB_BASEMENT
	name = "Basement"
