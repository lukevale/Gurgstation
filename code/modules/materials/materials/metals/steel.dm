...
/datum/material/steel/generate_recipes()
	...
	recipes += list(
		...
		new /datum/stack_recipe("tanning rack", /obj/structure/tanning_rack, 3, one_per_turf = TRUE, time = 20, on_floor = TRUE, supplied_material = "[name]"), //gurgs edit - god help me - luke
		new /datum/stack_recipe("floor bulb fixture frame", /obj/machinery/light_construct/floorbulb, 1, recycle_material = "[name]") //gurgs add
	)
